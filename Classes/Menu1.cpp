...
bool Menu1::init()
{
    ...
    play->setAnchorPoint(Point(-0.6, 1.0));
    ...
    about->setAnchorPoint(Point(0, 1.5));
    ...
    objectives->setAnchorPoint(Point(0, 1.5));
    ...
    settings->setAnchorPoint(Point(0, 1.5));
    ...
    store->setAnchorPoint(Point(0, 1.5));
    ...
    logo->setAnchorPoint(Vec2(0.01,0.01));
    ...
    //create a slimple slide up animation
